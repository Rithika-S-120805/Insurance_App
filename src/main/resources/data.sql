...
INSERT INTO claims (claim_number, policy_id, date_filed, claim_status, claim_amount, approved_amount, description, approval_date) VALUES ('CLM-2024-001', 1, '2024-06-15', 'APPROVED', 50000.00, 45000.00, 'Hospitalization claim', '2024-06-25');
INSERT INTO claims (claim_number, policy_id, date_filed, claim_status, claim_amount, approved_amount, description, approval_date) VALUES ('CLM-2024-002', 2, '2024-07-10', 'PENDING', 100000.00, NULL, 'Life insurance claim', NULL);

-- Insert test payment data
INSERT INTO payments (payment_reference, policy_id, payment_type, amount, payment_method, payment_status, payment_date, reference_number) VALUES ('PAY-2024-001', 1, 'Premium', 5000.00, 'Credit Card', 'COMPLETED', '2024-01-15', 'REF-CC-2024-001');
INSERT INTO payments (payment_reference, policy_id, claim_id, payment_type, amount, payment_method, payment_status, payment_date, reference_number) VALUES ('PAY-2024-002', 1, 1, 'Claim Settlement', 45000.00, 'Bank Transfer', 'COMPLETED', '2024-06-26', 'REF-BT-2024-001');
INSERT INTO payments (payment_reference, policy_id, payment_type, amount, payment_method, payment_status, payment_date, reference_number) VALUES ('PAY-2024-003', 2, 'Premium', 3000.00, 'Net Banking', 'COMPLETED', '2024-02-10', 'REF-NB-2024-001');
